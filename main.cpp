...
int main(int argc, char** argv) {
    ...
    for(size_t amount_dummy_training_images = 0;amount_dummy_training_images < 100;amount_dummy_training_images++){
        ...
        for(size_t i = 0;i < 3;i++){
            inputs[i][cross_positionx][cross_positiony] = 100;
            inputs[i][cross_positionx+1][cross_positiony] = 100;
            inputs[i][cross_positionx+2][cross_positiony] = 100;
            inputs[i][cross_positionx-1][cross_positiony] = 100;
            inputs[i][cross_positionx-2][cross_positiony] = 100;
            inputs[i][cross_positionx][cross_positiony+1] = 100;
            inputs[i][cross_positionx][cross_positiony+2] = 100;
            inputs[i][cross_positionx][cross_positiony-1] = 100;
            inputs[i][cross_positionx][cross_positiony-2] = 100;
        }
    ...
    conv.train(dummy_training,Convolutional::SIGMOID,0.01,0.1,2,1,1);
